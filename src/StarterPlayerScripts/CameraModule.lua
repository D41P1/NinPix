...
local ClassicCamera = require(script.Parent:WaitForChild("ClassicCamera"))
local OrbitalCamera = require(script.Parent:WaitForChild("OrbitalCamera"))
local LegacyCamera = require(script.Parent:WaitForChild("LegacyCamera"))
-- local VehicleCamera = require(script.Parent:WaitForChild("VehicleCamera"))
-- New VR System Modules
-- local VRCamera = require(script.Parent:WaitForChild("VRCamera"))
-- local VRVehicleCamera = require(script.Parent:WaitForChild("VRVehicleCamera"))

-- Load Roblox Occlusion Modules
local Invisicam = require(script.Parent:WaitForChild("Invisicam"))
local Poppercam = require(script.Parent:WaitForChild("Poppercam"))

-- Load the near-field character transparency controller and the mouse lock "shift lock" controller
local TransparencyController = require(script.Parent:WaitForChild("TransparencyController"))
local MouseLockController = require(script.Parent:WaitForChild("MouseLockController"))
...
do 
	...
	local TW = TweenInfo.new(0.3, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut, 0, false, 0)
	--local CurrentTween
	...
	function CameraModule:Update(dt)
		...
		currentCamera = game.Workspace.CurrentCamera :: Camera		
		if D >= S then 
			D -= S
			TS:Create(currentCamera, TW, {CFrame = newCameraCFrame}):Play()		
